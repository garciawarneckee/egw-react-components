...
export default class TextAndSubmit extends Component {
  ...
  render() {
    ...
    const themeInputClasses = classnames(`txtnsubmit txtnsubmit--${theme} txtnsubmit--input-${theme}`);
    const themeSubmitClasses = classnames(`txtnsubmit txtnsubmit--${theme} txtnsubmit--submit-${theme}`);
